...
public class IabHelper {
    ...
    boolean mSubscriptionsSupported = true;
    ...
    String getMarketAction(int market){
    	switch(market){
    	case MARKET_CANDO: return CANDO_SERVICE_ACTION;
    	case MARKET_BAZAAR: return BAZAAR_SERVICE_ACTION;
    	case MARKET_PLAY: return PLAY_SERVICE_ACTION;
    	default: return "";
    	}
    }
    String getMarketNamespace(int market){
    	switch(market){
    	case MARKET_CANDO: return CANDO_NAMESPACE;
    	case MARKET_BAZAAR: return BAZAAR_NAMESPACE;
    	case MARKET_PLAY: return PLAY_NAMESPACE;
    	default: return "";
    	}
    }
}